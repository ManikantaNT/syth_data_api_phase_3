...
from synthesizer.ctgan import CTGAN
from utility import get_discrete_cols
...
def main():
    """CLI."""
    args = _parse_args()
    # sys.stdout.write(str(get_discrete_cols(args,PATH )))
    args.discrete= get_discrete_cols(args,PATH)
    print(args.discrete)
